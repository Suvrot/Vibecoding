...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={`inline-flex h-10 items-center justify-center rounded-lg bg-white px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-white/90 disabled:pointer-events-none disabled:opacity-50 ${className}`}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={`inline-flex h-10 items-center justify-center rounded-lg border border-white/[0.08] bg-transparent px-4 py-2 text-sm font-medium text-foreground transition-colors hover:bg-white/[0.04] disabled:pointer-events-none disabled:opacity-50 ${className}`}
    {...props}
  />
));
